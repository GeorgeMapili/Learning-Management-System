...
<script>
    ...
    $("#formPost").on('submit', function(e){
        ...
        $.ajax({
            url: "http://localhost/lm/api/teacher/update_post.php",
            method: "POST",
            data: {
                classid: classid,
                postid: postid,
            ...
            success: function(response){
                if(response === "true"){
                    window.location.replace(`http://localhost/lm/teacher/main.php?id=${classid}`);
                }
            }
        });
    ...
    // Get the post
    $.ajax({
        url: "http://localhost/lm/api/teacher/updated_post.php",
        method: "POST",
        data: {
            classid: classid,
            postid: postid
