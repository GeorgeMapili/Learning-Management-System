<?php require_once('../layout/php_header/header_teacher.php'); ?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <header id="headers" class="fixed-top ">
        <div class="container d-flex align-items-center">
            ...
            <h1 class="logo mr-auto"><a href="myclass.php">NORSU</a></h1>

            <nav class="nav-menu d-none d-lg-block">
                <ul>
                    <li class="active">
                        <div class="btn-group">
                            <a href="myclass.php" class="btn btn-secondary">My Class</a>
