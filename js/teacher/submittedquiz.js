...
var quiz_id = classId.get('quiz_id');
...
$.ajax({
    url: "http://localhost/lm/api/teacher/view_quiz.php",
    method: "POST",
    data: {
        quiz_id: quiz_id,
        classid: classid
    ...
    success: function(response1){
        ...
        response1.forEach(element => {
            ...
            var a = $("<a>",{
                "download": "",
                "href": `../assets/quiz_submission/${element.quiz_submission_file}`
            })

            a.html(element.quiz_submission_file);

            td1.append(a);

            var td2 = $("<td>");

            td2.html(element.quiz_submission_description)

            var td3 = $("<td>");

            td3.html(element.quiz_submission_created_at.slice(0,11));
